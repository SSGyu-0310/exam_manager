...
class Config:
    ...
    # Output tokens
    GEMINI_MAX_OUTPUT_TOKENS = _env_int("GEMINI_MAX_OUTPUT_TOKENS", default=2048)

    # ========================================================================
    # Classifier Cache (kept for backward compatibility)
    # ========================================================================
    ...
    AUTO_CONFIRM_V2_DELTA_UNCERTAIN = float(
        os.environ.get("AUTO_CONFIRM_V2_DELTA_UNCERTAIN", "0.03")
    )
    AUTO_CONFIRM_V2_MIN_CHUNK_LEN = _env_int(
        "AUTO_CONFIRM_V2_MIN_CHUNK_LEN", default=200
    )
    ...
    SEMANTIC_EXPANSION_QUERY_MAX_CHARS = _env_int(
        "SEMANTIC_EXPANSION_QUERY_MAX_CHARS", default=1200
    )
    ...
    DATA_CACHE_DIR = os.environ.get("DATA_CACHE_DIR", str(BASE_DIR / "data" / "cache"))
